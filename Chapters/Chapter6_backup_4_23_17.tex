...
Figure \ref{fig6-20} shows wind speed in the computational domain at several key moments when feed forward derating control is enabled. The first few images in Figure \ref{fig6-20} look very similar to Figure \ref{fig6-14}. We see both turbines in a steady 12 m/s wind then we see the extreme coherent gust propagating through the computational domain and arriving at the upwind turbine. At t = 540 s we see the gust arriving at the downwind turbine and we see that the upwind turbine is no longer producing a wake, which indicates it has stopped operating. At t = 600 s we see a noteworthy difference between these simulation results and the results discussed in Subsection \ref{section6-6-2}. We see a wake trailing the downwind turbine. This indicates that it has not shut down in response to the extreme coherent gust.
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-21.png}
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-22.png}
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-23.png}
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-24.png}
...
\hline                             
\end{tabular}
\caption{Turbine performance metrics for the Offset Turbine test case with feed forward derating control.}
 \label{Table6-3}
\end{table}
...
\hline                             
\end{tabular}
\caption{Effect of feed forward derating control on downwind turbine performance for the Offset Turbine test case.}
 \label{Table6-4}
\end{table}
...
%	SUBSECTION 7-3
%-----------------------------------
\subsection{Performance With Feed Forward Derating Control} \label{section6-7-3}

Figure \ref{fig6-33} shows wind speed in the computational domain at several key moments when feed forward derating control is enabled. The first few images in Figure \ref{fig6-33} look very similar to the results presented in Section \ref{section6-7-2} (Figure \ref{fig6-27}). However, at t = 600 s we see a noteworthy difference between these simulation results and the results discussed in Subsection \ref{section6-7-2}. We see a wake trailing the downwind turbine. This indicates that it has not shut down in response to the extreme coherent gust.
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-34.png}
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-35.png}
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-36.png}
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-37.png}
...
\begin{figure}[!htbp] 
	\centering
		\includegraphics[width = \linewidth]{Figures/ch6Figures/fig6-38.png}
...
\hline
                                                                 &  & \begin{tabular}[c]{@{}c@{}}Tower base\\ DEL(MNm)\end{tabular} & & \begin{tabular}[c]{@{}c@{}}Blade root\\ DEL(MNm)\end{tabular} &  & \begin{tabular}[c]{@{}c@{}}Max\\ Overspeed(\%)\end{tabular} &  &  \begin{tabular}[c]{@{}c@{}}Energy\\ Gen.(kWh)\end{tabular}\\ 
\hline
\begin{tabular}[c]{@{}c@{}}Without FF \\ Control \end{tabular}   &  & 104.0                                                         & & 9.49                                                          &  & 16.03                                 				       &  &  194.51                                                     \\
\\
\begin{tabular}[c]{@{}c@{}}With FF \\ Control \end{tabular}      &  & 45.9                                                          & & 8.03                                                          &  &  11.70                                                      &  &  395.65                                                     \\
\\
\begin{tabular}[c]{@{}c@{}}Change in\\Performance\end{tabular}   &  & -58.1 (-55.8\%)                                               & & -1.46 (-15.4%)                                                &  &  -4.33                                                      &  &  +201.14 (+103.4\%)                                          \\
\\
\hline
\hline                             
\end{tabular}
\caption{Effect of feed forward derating control on downwind turbine performance for the Turbine in Wake test case.}
\label{Table6-8}
\end{table}
